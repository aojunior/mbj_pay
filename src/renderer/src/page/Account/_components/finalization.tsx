...
export function Finalization() {
    ...
    return(
        <>
            {isLoad && <Loading />}
            <Container style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 40,  height: '60vh'}}>

                <Title>Finalização do Cadastro</Title>
                <Message>
                    Verifique sua conta para concluir o cadastro. O processo de validação pode demorar até 10 minutos.
                </Message>
                <Button style={{width: 150,}} onClick={handleVerifyAccount}>Verificar Conta</Button>
